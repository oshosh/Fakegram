# Fakegram (instargram 모방 개인 연습 프로젝트)
  ...
  ```
    ...
    댓글 더보기 id 관련 중복 문제로 인한 - 더미 데이터 생성용 npm 추가
    shortId
    
    가짜 게시물, 가짜 이미지, 가짜 콘텐츠 데이터 - 더미 데이터 생성용 npm 추가
    faker
  ```
 ...
 ```
  ...
  ㄴheader
    ...
    ㄴ 아바타
       ㄴ 프로필
          ㄴ 서브 탭 관리 (3개)
          ㄴ 팔로잉      ㄴ 팔로워    ㄴ저장 게시물 관리 (다이나믹 id ? 혹은 back id 로 뿌릴지 미정..)
     ...
     ㄴ 포스트 카드 (PostCard)
        ...
        ㄴ포스트 카드 아이템 (PostCardBody - 툴팁 추가)
          ...
          ㄴ 댓글 보기 
             ...
             ㄴ 댓글 갯수
          ㄴ 리트윗
          ㄴ 게시물 저장 (저장 게시물 관리랑 연계... saga까지 진행 )
        ㄴ댓글 달기 (CommentForm)
          ㄴ 이모지 기능 추가
     ㄴ 포스트 작성 (PostForm)
        ㄴ 이모지
